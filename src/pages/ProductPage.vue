...
const { loading, perPage, totalPages, currentPage, paginatedLists, searchQuery, detailData } = storeToRefs(listStore);
const { fetchListData, setPerPage, changePage, toggleSort, deleteItem, setSearchQuery, detail } = listStore;
...
<template>
  <section class="bg-white w-full rounded-md p-4">
    <h1 class="text-xl font-bold">List Data Product</h1>
    <div class="mt-4">
      <TextInput :model-value="searchQuery" @input="onSearchChange" placeholder="Search Item..." />
